...
public class HelloUser {
    public static void main(String[] args) {
         ...
         * a string called name is used to store that value which the user gave so we can reuse the
         * value when ever we want
        ...
        System.out.println("Hello " + name + " welcome on board"); // simple print line and the user's value is being
                                                                   // used here
